        ...
        templates.push(
          <div >
            <div className="mdc-layout-grid"id='intro' >
                This is an animation of Ebola confirmed cases in the North Kivu Ebola Outbreak in the Democratic Republic of the Congo.
                <button className="mdc-button" onClick={this._handleDialog}>
                  <div className="mdc-button__ripple"></div>
                  <span className="mdc-button__label">Click here for a guide to the app</span>
                </button>
              <Dialog open={isOpen}>
